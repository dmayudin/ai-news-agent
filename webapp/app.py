...
def api_generate():
    ...
    try:
        ...
        if gen_type == 'post':
            ...
            prompt = (
                'Ты — редактор Telegram-канала @ai_is_you об искусственном интеллекте.\n'
                'Составь дайджест на русском языке из новостей ниже.\n'
                '\n'
                'Формат дайджеста:\n'
                '  Первая строка: заголовок дайджеста (жирный, без тегов, например: Дайджест AI-новостей — 1 апреля)\n'
                '  Пустая строка.\n'
                '  Затем 5–7 пунктов в следующей структуре:\n'
                '\n'
                '  <b>КРАТКИЙ ЗАГОЛОВОК ПО СУТИ НОВОСТИ</b>\n'
                '  1–2 предложения с подробным описанием: что произошло, почему важно.\n'
                '  <a href="ССЫЛКА">→ источник</a>\n'
                '\n'
                'Требования:\n'
                '  - Заголовок каждого пункта — это суть новости (не название источника!).\n'
                '    Плохо: «TechCrunch: OpenAI выпустила модель».\n'
                '    Хорошо: «OpenAI выпустила GPT-5 с поддержкой видео».\n'
                '  - Описание: 1–2 предложения, конкретно и по делу, без воды.\n'
                '  - Ссылка в конце каждого пункта через HTML-тег <a href="...">→ источник</a>.\n'
                '  - Стиль: строгий, информативный, экспертный.\n'
                '  - Без хэштегов. Без эмодзи.\n'
                '\n'
                'Новости:\n' + news_block
            )
